  ...
  <v-card class="mb-4">
    <v-row justify="center" dense>
      <v-col cols="4" class="pa-2">
        <v-img :src="book.pictureUrl" contain></v-img>
      </v-col>
      <v-col cols="8" class="d-flex flex-column pa-0" align="">
        ...
        <v-card-text class="text-left pa-0">
          <v-card-title class="caption pa-1">
            <v-icon class="mr-2" color="black" size="15">fa-pencil-alt</v-icon>
            {{ getAuthor(book.author) }}
          </v-card-title>
        </v-card-text>
        <v-card-text class="text-left pa-0">
          <v-card-title class="caption pa-1">
            <v-icon class="mr-2" color="black" size="15">fa-book</v-icon>
