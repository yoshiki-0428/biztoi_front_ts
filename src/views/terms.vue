<template>
  <div>
    <div class="text-left pa-10 white black--text">
      <h1 class="title font-weight-bold mb-3">BizToi 利用規約</h1>
      <p class="caption">
        この利用規約（以下，「本規約」といいます。）は，BizToi（以下，「甲」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>

      <h2 class="subtitle-1 font-weight-bold mb-3">第1条（適用）</h2>
      ...
      <h2 class="subtitle-1 font-weight-bold mb-3">第2条（利用登録）</h2>
      <ol class="caption mb-3">
        <li>
          本サービスにおいては，登録希望者が本規約に同意の上，甲の定める方法によって利用登録を申請し，甲がこれを承認することによって，利用登録が完了するものとします。
        </li>
        <li>
      ...
      <ol class="caption mb-3">
        ...
        <li>
          ユーザーは，いかなる場合にも，ユーザーIDおよびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。甲は，ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのユーザーIDを登録しているユーザー自身による利用とみなします。
        </li>
        <li>
          ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，甲に故意又は重大な過失がある場合を除き，甲は一切の責任を負わないものとします。
        </li>
      </ol>
      ...
      <h2 class="subtitle-1 font-weight-bold mb-3">第5条（禁止事項）</h2>
      <p>
      ...
      <ol class="caption mb-3">
        ...
        <li>
          甲，ほかのユーザー，またはその他第三者のサーバーまたはネットワークの機能を破壊したり，妨害したりする行為
        </li>
        <li>本サービスによって得られた情報を商業的に利用する行為</li>
        <li>甲のサービスの運営を妨害するおそれのある行為</li>
        ...
        <li>
          甲が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為
        </li>
      ...
      <ol class="caption mb-3">
        <li>
          ...
          <ol>
            ...
            <li>その他，甲が本サービスの提供が困難と判断した場合</li>
          </ol>
        </li>
        <li>
      ...
      <ol class="caption mb-3">
        <li>
          甲は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。
          <ol>
            <li>本規約のいずれかの条項に違反した場合</li>
            <li>登録事項に虚偽の事実があることが判明した場合</li>
            <li>料金等の支払債務の不履行があった場合</li>
            <li>甲からの連絡に対し，一定期間返答がない場合</li>
            <li>本サービスについて，最終の利用から一定期間利用がない場合</li>
            <li>その他，甲が本サービスの利用を適当でないと判断した場合</li>
          </ol>
        </li>
        <li>
      ...
      <h2 class="subtitle-1 font-weight-bold mb-3">第8条（退会）</h2>
      <p class="caption mb-3">
        ユーザーは，甲の定める退会手続により，本サービスから退会できるものとします。
      </p>
      ...
      <h2 class="subtitle-1 font-weight-bold mb-3">第11条（利用規約の変更）</h2>
      <p class="caption mb-3">
      ...
      <h2 class="subtitle-1 font-weight-bold mb-3">第13条（通知または連絡）</h2>
      <p class="caption mb-3">
